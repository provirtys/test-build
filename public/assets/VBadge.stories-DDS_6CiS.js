import{c as m}from"./VTable-DnoZjJu1.js";import"./BarcodeIcon-CtJXGP-A.js";import"./DatamatrixIcon-B55ioFzH.js";import"./VExpansionItem-8mNTCM7g.js";import{c as p}from"./iframe-Cpxs_JI5.js";import"./preload-helper-Dp1pzeXC.js";const g={success:"Зеленый",error:"Красный",info:"Синий",warning:"Желтый"},u={lg:"Большой",md:"Средний",sm:"Маленький"},er={component:m,argTypes:{label:{description:"Текст элемента"},size:{description:"Размер элемента",options:Object.keys(u),control:{type:"select",labels:u}},color:{description:"Цвет элемента",options:Object.keys(g),control:{type:"select",labels:g}},isInverted:{description:"Поменять местами цвета",control:{type:"boolean"}}},args:{label:"Название",size:"lg",color:"info",isInverted:!1},render:d=>({components:{VBadge:m},setup(){const N=p(()=>{const{label:R,...Q}=d;return Q}),P=p(()=>d.label);return{bindingArgs:N,label:P}},template:`
...
}`,...(M=(L=n.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};var _,B,T;c.parameters={...c.parameters,docs:{...(_=c.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    label: 'Отменено',
    color: 'error'
  }
}`,...(T=(B=c.parameters)==null?void 0:B.docs)==null?void 0:T.source}}};var V,h,q;t.parameters={...t.parameters,docs:{...(V=t.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    label: 'Отменено',
    color: 'error',
    isInverted: true
...
}`,...(K=(J=i.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const sr=["Large","Medium","Small","ColorInfoInverted","ColorSuccess","ColorSuccessInverted","ColorError","ColorErrorInverted","ColorWarning","ColorWarningInverted"];export{c as ColorError,t as ColorErrorInverted,o as ColorInfoInverted,a as ColorSuccess,n as ColorSuccessInverted,l as ColorWarning,i as ColorWarningInverted,r as Large,e as Medium,s as Small,sr as __namedExportsOrder,er as default};
