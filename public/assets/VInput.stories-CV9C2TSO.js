import{g as P}from"./VTable-DnoZjJu1.js";import"./BarcodeIcon-CtJXGP-A.js";import"./DatamatrixIcon-B55ioFzH.js";import"./VExpansionItem-8mNTCM7g.js";import{s as De}from"./sleep-B5LgeCuU.js";import{r as Fe,c as ke,w as Ne}from"./iframe-Cpxs_JI5.js";import"./preload-helper-Dp1pzeXC.js";const{expect:l,userEvent:n,waitFor:f}=__STORYBOOK_MODULE_TEST__,R={standard:"Обычный",outlined:"С границами",filled:"Заполненный"},B={text:"Текст",number:"Число",textarea:"Textarea",password:"Пароль",date:"Дата",time:"Время","datetime-local":"Дата-время"},Ye={component:P,argTypes:{type:{description:"Тип поля ввода",options:Object.keys(B),control:{type:"select",labels:B},table:{category:"props"}},variant:{description:"Стиль поля ввода",options:Object.keys(R),control:{type:"select",labels:R},table:{category:"props"}},label:{description:"Название поля",table:{category:"props"}},modelValue:{description:"Значение поля",table:{category:"props"}},placeholder:{description:"Заглушка для поля"},labelOutside:{description:"Название за границами поля ввода",options:[!0,!1]},required:{description:"Обязательное поле",options:[!0,!1]},dense:{description:"Занимать меньше пространства",options:[!0,!1],control:{type:"boolean"},table:{category:"props"}},xPadding:{description:"Горизонтальный отступ"},labelOnBorder:{description:"Отображать название на границе в `outlined` режиме"},displayNumberWithDelimiter:{description:"Отображать значение в формате 1 000 000 (только цифры)"},borderRadius:{description:"Радиус границы"}},args:{type:"text",variant:"standard",label:"",modelValue:"",placeholder:"",labelOutside:!1,required:!1,dense:!1,xPadding:"",labelOnBorder:!0,displayNumberWithDelimiter:!1,borderRadius:"8px"},render:e=>({components:{VInput:P},setup(){const r=Fe(e.modelValue),a=ke(()=>{const t={...e};return t.variant=void 0,e.variant,e.variant&&e.variant!==R.standard&&(t[e.variant]=!0),t});return Ne(r,t=>{e.modelValue=t}),{modelValue:r,inputProps:a,args:e}},template:`
