  ...
  <div class="marking-card">
    <div class="marking-card__main">
      ...
      <div class="marking-card__head flex-space-between">
        ...
        <p>
          {{ codeInfo.labeled }}
          <span class="grey-text">/ {{ codeInfo.total }}</span>
        </p>
      </div>
      ...
      <div class="marking-card__info">
        <div class="marking-card__code-info">
          <div>
            <p class="marking-card__info__title grey-text">
              {{ t('datetime') }}
            </p>
            <p class="marking-card__info__date">
              {{ getCodeDate(codeInfo.ts) }}
            </p>
            <!-- <p class="main__info__date">{{ getCodeDate(codeInfo.ts) }}</p>-->
            <p class="marking-card__info__value grey-text">
              {{ getCodeTime(codeInfo.ts) }}
            </p>
          </div>
          <div>
