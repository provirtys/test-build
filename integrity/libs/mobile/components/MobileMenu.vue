...
function isPageActive(page) {
  switch (page) {
    ...
    case 'scan':
      return ['Checking', 'CheckScan', 'CheckResult'].includes(
        props.currentPage
      );
    case 'history':
