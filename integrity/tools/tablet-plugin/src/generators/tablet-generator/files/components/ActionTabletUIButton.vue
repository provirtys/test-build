<template>
  <button
      ...
      class="action-tablet-ui-btn" :disabled="props.isDisabled"
      :class="[{ 'text-center': props.locationIcon }, { 'done-icon': isActionSubmitted }, backgroundColor, buttonSize, borderRadius, {'min-width-empty': props.locationIcon === '' }]"
  >
    <TabletUIDone v-if="isActionSubmitted" :icon-color="colorIcon" :icon-size="sizeIcon"></TabletUIDone>
    <TabletUIArrow v-if="props.locationIcon === 'left' && buttonIcon" :icon-color="colorIcon" :icon-size="sizeIcon"></TabletUIArrow>
    {{ buttonText }}
    <TabletUIArrow v-if="props.locationIcon === 'right' && buttonIcon" :icon-color="colorIcon" :icon-size="sizeIcon"></TabletUIArrow>
  </button>
</template>
