import MobileScanner from '../mobile/MobileScanner.vue'
...
export default {
    ...
    argTypes: {
        ...
        helper: {
            description: 'Вспомогательный текст. Параметры: type (\'red\' - красный текст сообщения об ошибке или \'\' - обычная информация), text - текст сообщения.',
            control: {
                type: 'object'
            }
        },
