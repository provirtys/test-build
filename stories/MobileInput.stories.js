import MobileInput from '../mobile/MobileInput.vue'
import scanIconUrl from '../images/scan-icon.svg'
...
export default {
    ...
    argTypes: {
        ...
        placeholder: {
            description: 'Пример заполнения, текст-подсказка, отображающийся, когда поле ввода не заполнено.',
        },
        errorText: {
