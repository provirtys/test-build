import StatusBar from "../tablet/StatusBar.vue";
...
/** Компонент StatusBar отображает кнопку Выход/Назад, наименование задачи и стату готовности принтера, а также кнопку Новое задание */
export default {
