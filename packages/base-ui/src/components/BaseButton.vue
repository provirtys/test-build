...
const classes = computed(() => {
    const bg = props.isDisabled ? "gray-bg" : props.background === "red" ? "red-bg" : "transparent";
    const border = props.color === "white" ? "no-border" : props.color === "black" ? "black-border" : "red-border";
    const button_size = props.size === "large" ? "large" : props.size === "full" ? "full" : "medium";
