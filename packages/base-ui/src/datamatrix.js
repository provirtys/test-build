// biome-ignore lint: This code need rewrite
        ...
        encodeMsg = (text, rct) => {
            ...
            var enc = toAscii(text),
                ...
                k = toText(
                    text,
                    [
                        /* C40 */ 230, 31, 0, 0, 32, 9, 29, 47, 1, 33, 57, 9, 44, 64, 1, 43, 90, 9, 51, 95, 1, 69, 127,
                        2, 96, 255, 1, 0,
                    ],
                ),
                l = k.length;
            ...
            k = toText(
                text,
                [
                    /* TEXT */ 239, 31, 0, 0, 32, 9, 29, 47, 1, 33, 57, 9, 44, 64, 1, 43, 90, 2, 64, 95, 1, 69, 122, 9,
                    83, 127, 2, 96, 255, 1, 0,
                ],
            );
            l = k.length;
            ...
            k = toText(
                text,
                [
                    /* X12*/ 238, 12, 8, 0, 13, 9, 13, 31, 8, 0, 32, 9, 29, 41, 8, 0, 42, 9, 41, 47, 8, 0, 57, 9, 44,
                    64, 8, 0, 90, 9, 51, 255, 8, 0,
                ],
            );
            l = k.length;
            if (l > 0 && l < el) (enc = k), (el = l);
            ...
            var nr = 1;
            var fw;
            var fh /* symbol size, regions, region size */;
            var i;
            var j = -1;
            var c;
            var r;
            var s;
            var b = 1 /* compute symbol size */;
            var rs = new Array(70) /* reed / solomon code */;
            var rc = new Array(70);
            var lg = new Array(256) /* log / exp table for multiplication */;
            ...
            if (rct && el < 50) {
                ...
                i = 2; /* size increment */
                k = [
                    5, 7, 10, 12, 14, 18, 20, 24, 28, 36, 42, 48, 56, 68, 84, 112, 144, 192, 224, 272, 336, 408, 496,
                    620,
                ]; /* rs checkwords */
            ...
            for (i = 0; i < l; r -= s, c += s) {
                if (r == h - 3 && c == -1)
                    k = [/* corner A layout */ w, 6 - h, w, 5 - h, w, 4 - h, w, 3 - h, w - 1, 3 - h, 3, 2, 2, 2, 1, 2];
