import{S as E}from"./StatusCard-BbuMKw16.js";import"./iframe-00K2Dmlk.js";import"./preload-helper-BVW3a-N4.js";import"./base-ui.es-KFfLC6Sd.js";import"./colors-BttFFNdH.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const l={success:"Зеленый",error:"Красный",info:"Синий",warning:"Желтый"},_={component:E,argTypes:{title:{description:"Заголовок карточки (сверху вверху)"},text:{description:"Основное значение (слева внизу)"},label:{description:"Дескриптор (рядом с `text`)"},color:{description:"Цвет карточки",options:Object.keys(l),control:{type:"select",labels:l}},progress:{description:"Ширина цветного фона. <br/> От `0` до `100`",control:{min:0,max:100}},togglerStatus:{description:`Статус переключателя:<br/>
